/**
 * The Bauer CA10 — Nostalgic Décor family detail data
...
const ca10Data = {
  ...
  tagline: 'California warmth in a flame-tip form.',
  description: 'California warmth in a flame-tip form. The Bauer CA10 draws on the warm ceramic tradition of Bauer Pottery — a flame-tip candelabra shape with a 2400K amber glow that evokes the handmade warmth of California mid-century craft. For decorative chandeliers, sconces, and any fixture where the lamp tip is visible and the warmth of the light matters.',
  heroImage: '',
  echelon: undefined,
  keySpecs: {
    inputWatts: '3.5–4.5W',
