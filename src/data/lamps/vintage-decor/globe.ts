...
const globeData = {
  ...
  description: 'G25 and G40 globe lamps in amber and smoked finishes.',
  heroImage: '',
  echelon: undefined,
  keySpecs: {
    inputWatts: '2–4.5W',
...
export const siblingFamilies = [
  { slug: 'candelabra', name: 'Candelabra', skuCount: 11, tagline: '' },
  { slug: 'edison', name: 'Edison', skuCount: 11, tagline: '' },
  { slug: 'radio', name: 'Radio', skuCount: 11, tagline: '' },
  { slug: 'tubular', name: 'Tubular', skuCount: 11, tagline: '' },
  { slug: 'victorian', name: 'Victorian', skuCount: 11, tagline: '' },
];
