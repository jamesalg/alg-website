...
const edisonData = {
  ...
  description: 'ST19 Edison lamps in clear, amber, and smoked finishes.',
  heroImage: '',
  echelon: undefined,
  keySpecs: {
    inputWatts: '2–4.5W',
...
export const siblingFamilies = [
  { slug: 'candelabra', name: 'Candelabra', skuCount: 14, tagline: '' },
  { slug: 'globe', name: 'Globe', skuCount: 14, tagline: '' },
  { slug: 'radio', name: 'Radio', skuCount: 14, tagline: '' },
  { slug: 'tubular', name: 'Tubular', skuCount: 14, tagline: '' },
  { slug: 'victorian', name: 'Victorian', skuCount: 14, tagline: '' },
];
