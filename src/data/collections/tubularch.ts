...
const tubularchData = {
  ...
  statStrip: [
    ...
    { value: 'CRI',   label: '90+' },
    { value: '25k-hr',label: 'L80' },
    { value: 'Dim',   label: 'to 5%' },
  ],
  redBanner: [
  ...
  familiesHeadline: 'The lamps that finish the room.',
  familiesSubhead: 'Tubular and radio-tube filament LEDs in T9, T10, T14 and other long-form envelopes.',
  legacy: {
